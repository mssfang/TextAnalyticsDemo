...
export default class LinkedEntitiesRecognition extends React.Component {
  constructor(props) {
    super(props);
    localStorage.removeItem("id1");
    this.state = {result: localStorage.getItem("id1"), items: [], isIncludeStats: false};
  ...
  // url builder
  urlBuilder = () => {
    var url = "http://localhost:8080/recognizeLinkedEntitiesBatchString?";
  ...
  render() {
    return (
      <div>
        <H1>Linked Entities Recognition</H1>
